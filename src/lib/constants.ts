...
export const PLATFORMS: PlatformDef[] = [
  ...
  },
  {
    ...
    procedure: [
      ...
      { title: "Enter credentials here", body: "Paste your Phone Number ID, Access Token, and Verify Token into the fields, then click Connect. We'll validate your credentials with Meta and auto-generate your webhook URL." },
      { title: "Copy the webhook URL into Meta", body: "After connecting, your webhook URL is shown in the success toast (looks like https://your-domain.com/api/webhooks/whatsapp?i=...). Paste it into WhatsApp settings → 'Webhook' → 'Callback URL'. Enter the SAME Verify Token you used here, then subscribe to 'messages'. The webhook auto-verifies when Meta calls our GET endpoint." },
      ...
      { title: "Send a test message", body: "Send any text to your WhatsApp Business number from the test phone. Your agent will reply within seconds! Incoming + outgoing messages are logged in the monitoring panel below." },
    ],
  },
  {
    ...
    procedure: [
      ...
      { title: "Enter the token here", body: "Paste the Bot Token into the field above and click Connect. The system validates the token with Telegram and automatically registers a webhook — no manual setup needed." },
      { title: "Test your bot", body: "In Telegram, search for your bot's username → click Start → send a message. Your agent will reply within seconds! If it doesn't respond, make sure your server is publicly accessible (Telegram needs to reach the webhook URL)." },
  ...
  },
  {
    ...
    procedure: [
      ...
      { title: "Enter credentials here", body: "Paste your Bot Token (xoxb-) and Signing Secret into the fields, then click Connect. We'll validate the token with Slack's auth.test API and auto-generate your webhook URL." },
      { title: "Enable Event Subscriptions", body: "After connecting, your webhook URL is shown in the success toast (looks like https://your-domain.com/api/webhooks/slack?i=...). In Slack go to 'Event Subscriptions' → toggle ON → paste the URL as the Request URL. Slack will auto-verify it via a url_verification handshake. Subscribe to bot events: app_mention, message.im." },
      { title: "Mention your bot to test", body: "Invite the bot to a channel (or DM it directly), then @mention it. Your agent will reply within seconds! Incoming + outgoing messages are logged in the monitoring panel below." },
    ],
  },
  {
